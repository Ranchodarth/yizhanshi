<template>
    <div>
        ...
        <div class="searchMouder">
            <el-form ref="form" :inline="true" :model="form" label-width="84px">
                <el-form-item label="申请人姓名" class="mr10">
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="contacts" label="申请人姓名" align="center"></el-table-column>
                ...
                <el-table-column prop="startDate" label="申请时间" align="center"></el-table-column>
                <el-table-column prop="creater" label="处理人" align="center"></el-table-column>
                <el-table-column prop="FinisfDate" label="处理时间" align="center"></el-table-column>
